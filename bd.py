...
def consultar_amostra():
    ...
    print('\n')
    print('Valor de MP10: ', retorno[0])
    print('Valor de MP25: ', retorno[1])
    print('Valor de O3: ', retorno[2])
    print('Valor de CO: ', retorno[3])
    print('Valor de NO2: ', retorno[4])
    print('Valor de SO2: ', retorno[5])
    print('\n')
    os.system("pause")
    os.system("cls")
...
def imprimir_media_poluente():
    ...
    retorno = cursor.fetchone()
    print('Media de MP10: ', retorno[0])
    print('Media de MP25:', retorno[1])
    print('Media de O3:', retorno[2])
    print('Media de CO:', retorno[3])
    print('Media de NO2:', retorno[4])
    print('Media de SO2:', retorno[5])
    print('\n')
